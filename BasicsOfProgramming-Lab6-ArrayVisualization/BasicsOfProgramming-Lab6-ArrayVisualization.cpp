// BasicsOfProgramming-Lab6-ArrayVisualization.cpp : Определяет точку входа для приложения.
//

//#include "framework.h"
//#include "BasicsOfProgramming-Lab6-ArrayVisualization.h"
//IDC_BASICSOFPROGRAMMINGLAB6ARRAYVISUALIZATION
	...
	_In_ int       nCmdShow)
{
	...
	LoadStringW(hInstance, IDC_BASICSOFPROGRAMMINGLAB6ARRAYVISUALIZATION, szWindowClass, MAX_LOADSTRING);
	...
	HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_BASICSOFPROGRAMMINGLAB6ARRAYVISUALIZATION));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDC_BASICSOFPROGRAMMINGLAB6ARRAYVISUALIZATION));
	wcex.hCursor = LoadCursor(nullptr, IDC_ARROW);
	wcex.hbrBackground = (HBRUSH)(COLOR_WINDOW + 1);
	wcex.lpszMenuName = MAKEINTRESOURCEW(IDC_BASICSOFPROGRAMMINGLAB6ARRAYVISUALIZATION);
